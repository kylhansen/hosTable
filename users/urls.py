...
urlpatterns = [
    path('<int:pk>/', ProfileDetailView.as_view(template_name='users/view.html'), name='user-view'),
    path('<int:pk>/update', UserUpdateView.as_view(template_name='users/update.html'), name='user-update'),
    path('<int:pk>/profile/update', ProfileUpdateView.as_view(template_name='users/update.html'), name='user-profile-update'),
